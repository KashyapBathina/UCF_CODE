...
int main(int argc, char *argv[]) {
    ...
    if (fp == NULL) 
        ...
        // printing the number of valid orders after we have finished all the functions and gone through all the permutations 
...
void validOrder(person people_attending[]) {
    ...
    // if reach this point, then the permutation is valid; accordingly, increment numOfValidOrders 
    numOfValidOrders++;
}
